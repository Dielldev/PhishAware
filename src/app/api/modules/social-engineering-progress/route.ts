...
export async function GET() {
  try {
    ...
    const totalQuizzes = 4 // Total number of social engineering quizzes
    const totalChallenges = 3 // Total number of social engineering scenarios
    ...
    console.error('Error fetching social engineering progress:', error)
