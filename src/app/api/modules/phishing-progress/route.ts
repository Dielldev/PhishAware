...
export async function GET() {
  try {
    ...
    const totalQuizzes = 4 // Total number of phishing quizzes
    const totalChallenges = 3 // Total number of phishing challenges
    ...
    console.error('Error fetching phishing progress:', error)
